            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        <img class="w-[200px] ml-[5px] flex-none" src="/assets/images/Logo-LightFlow.png" alt="" />
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <router-link to="/" @click="toggleMobileMenu">{{ $t('orders') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/analytics" @click="toggleMobileMenu">{{ $t('elements') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/finance" @click="toggleMobileMenu">{{ $t('inventory') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('paidOrders') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('shippingOrders') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('gourmetPaid') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('gourmetShipped') }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/crypto" @click="toggleMobileMenu">{{ $t('incompleteOrders') }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        </li>
                            ...
                            <ul>
                                ...
                                <li class="nav-item">
                                    <router-link to="/apps/contacts" class="group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <svg
                                                class="group-hover:!text-primary shrink-0 rotate-90"
                                                width="20"
                                                height="20"
                                                viewBox="0 0 24 24"
                                                fill="none"
